...
int createInputFile(const FLAGS* fls, const TARGET_ATTRIBUTES* atr, const char* targetname)
{
    ...
    fprintf(fp, "File auto-generated by GM program. \n"
         "Please write some macro prototypes and use GM to create C header file from it.\n\n"
         );
    ...
    */
    fprintf(fp,
        "                                                                   \n"
        "Write some macros and use 'gm filename' command                    \n"
        "   to create C header file with '#define' macros.                  \n"
        "Use 'gm --help' for more info.                                     \n"
        "                                                                   \n"
        "-------------------------------------------------------------------\n"
        "                                                                   \n"
